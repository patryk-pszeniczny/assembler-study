...
accept cx:0001h         \ ustawienie CX
accept ax:F1A5h         \ ustawienie AX
accept bx:0024h         \ ustawienie BX
accept cx:5321h         \ ponowne ustawienie CX (korekta)
...
odczyt_rozkazu
	...
	\ lab 6
	{xor nil,rq,B100h;fl;} {cjp RM_Z,roz_mov_cl_wyk;}
	{xor nil,rq,1500h;fl;} {cjp RM_Z,roz_adc_acc_wyk;}
wroc
{end;}
...
roz_mov_cl_wyk
	{and nil, rr, 0400h;fl;}\spr. czy zapis inf.do starszych 8 bitow rejestrow czy mlodszych
	{cjp rm_z, mlodsze;}

starsze
	{and rr,rr,FBFFH;} \ zerowanie bitu odpowiedzialnego za wybor starszych 8 bitow rejestrow
	{mov nil,rr;ewb;oey;}\w rejestrze rb numer calego 16 bitowego rejestru
	{or rq, rb,z;} \odczyt rejestru 16 bitowego o numerze w rb do rq
	{and rq,rq,00FFh;} \mlodsze 8 bitow zachowane w rq
	{and pom1,rr,00FFh;}\wydzielenie Data8 z rozkazu rr i zapis na 8 mlodszych bitach w pom1
	{push nz,7;}\ przesuniecie w pom1 z 8 mlodszych bitow do 8 starszych
	{sll pom1;}
	{rfct;}
	{or rq,rq,pom1;} \utworzenie calej zawartosci rejestru 16 bitowego w rq
	{mov rb,rq;} \zapis rq do rejestru wskazanego przez rb
	{jmap zapis_powrotny;}

mlodsze
	{or rq, cx,z;} \odczyt rejestru 16 bitowego z cx do rq
	{and rq,rq,FF00h;} \starsze 8 bitow zachowane w rq
	{and pom1,rr,00FFh;}\wydzielenie Data8 z rozkazu rr i zapis na 8 mlodszych bitach w pom1
	{or rq,rq,pom1;} \utworzenie calej zawartosci rejestru 16 bitowego w rq
	{mov cx,rq;} \zapis rq do rejestru cx
	{jmap zapis_powrotny;}
...
roz_adc_acc_wyk
	{add ip,ip,1,z;fl;}        \ Przesunięcie wskaźnika instrukcji o 1 (kolejny bajt), aktualizacja znaczników
	{cjp rm_z,modyf_css;}      \ Jeśli bit `rm_z` ustawiony, to skocz do procedury modyfikującej segment `cs`
	{jmap odczyt_drugiej_komorki_adc;} \ Skok do procedury odczytującej drugą komórkę z RAM

	
odczyt_drugiej_komorki_adc \operacja and 2 bajtowa
	{mov pom1,cs;}
	{mov rq,ip;}
	{cjs nz,obadrfiz;}
	{and nil, pom1,pom1;oey;ewl;}
	{and nil, pom2,pom2;oey;ewh;}
	{xor r7,r7,r7;} \zerowanie r7 (di)
	{R; mov r7,bus_d;cjp rdm,cp;}\w r7 odczytana druga komorka(2 bajtowa) z RAM
...
dodawanie
	{load rm,rn;}
	{xor pom1,pom1,pom1;}\zerowanie pom1
	{add pom1,pom1,z,rm_c;}\w pom1 wartosc przeniesienia
	{add ax,ax,r7,z;fl;} \sama operacja dodawania
	{cjp not rm_c, etykieta1;} \jesli nie bylo przeniesienia to skok
	{add ax,ax,pom1,z;fl;cem_c;}\bylo przeniesienie z pierwszej operacji dodawania; operacja drugiego
	\ dodawania z pom1; drugiego przeniesienia byc nie moze ; cem_c
	\ zachowuje bez zmian flagę przeniesienia.
	{jmap etykieta2;}
	
	etykieta1
	{add ax,ax,pom1,z;fl;}\brak przeniesienia z pierwszej operacji dodawania; operacja drugiego
	\ dodawania uwzglednia ewent przeniesienie z pom1
	{jmap zapis_powrotny;}
